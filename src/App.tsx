  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      detailedContent: {
        ...
        contributions: [
          ...
          "Sketches → Lo-fi mocks → Digital prototypes (in AdobeXD) → Iterated with users",
