...
export default function App() {
  ...
  const caseStudies: CaseStudy[] = [
    ...
    },
    {
      ...
      detailedContent: {
        overview: {
          roleAndTeam: "As UX Designer, I collaborated with a cross-functional team including Product, Developement, Business and Marketing to modernize and unify the provider experience at Magellan Health.",
          problemStatement: "The Provider Portal was a major initiative to consolidate multiple legacy features into a single, streamlined platform. Practitioners needed and wanted a modern, centralized environment to manage practice information, staff roster information, register clients, file EAP claims and access essential resources. Fragmented workflows across multiple legacy tools created inefficiency and user confusion. ",
          solution: "We designed a unified portal solution that consolidated legacy functionality into a single, intuitive multi-feature platform. A key feature was the one-time account 'handshake', enabling providers to transition smoothly from the legacy system while preserving account data and permissions. The portal simplified workflows for practice and practitioner (roster) management, claims registration and submission and user access while ensuring consistent UI/UX across all features.",
        },
        contributions: [
          "UX Design for the entire Provider Portal experience: Designed the 10-section Provider Data Change Form, EAP Services, Staff roster and broader portal workflows for a seamless, intuitive experience",
          ...
          "Stakeholder & User Collaboration: Coordinated with Legal, Marketing, Product and Developement for design reviews",
          "Conducted user research and pilot sessions for all feature workflows",
          "Designed complex workflows for practice information management, staff management, claims submission and account migration",
      ...
      <section id="work" className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="mb-4" style={{fontSize: '2rem'}}>Featured Work</h2>
